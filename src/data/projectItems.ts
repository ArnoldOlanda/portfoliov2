import peliculasApp from '/src/assets/peliculas-app.png';
import repetsApp from '/src/assets/repets-app.png';
import todoApp from '/src/assets/todo-app.png';
import paymentsApp from '/src/assets/payments-app.png';
import notesApp from '/src/assets/notes-app-vue-nest.png';
import librarySystem from '/src/assets/library-system.png';
